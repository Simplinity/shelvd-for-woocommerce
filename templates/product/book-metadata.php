 ...
 * yourtheme/wc-flavor-books/product/book-metadata.php
 *
...
<div class="wc-flavor-books-metadata">

	<?php if ( ! is_wp_error( $authors ) && ! empty( $authors ) ) : ?>
		<div class="book-field book-authors">
			<span class="book-field-label"><?php esc_html_e( 'Author:', 'wc-flavor-books' ); ?></span>
	...
	<?php if ( ! is_wp_error( $publishers ) && ! empty( $publishers ) ) : ?>
		<div class="book-field book-publishers">
			<span class="book-field-label"><?php esc_html_e( 'Publisher:', 'wc-flavor-books' ); ?></span>
			<span class="book-field-value">
				<?php
				$links = array();
	...
	<?php if ( ! empty( $meta['isbn'] ) ) : ?>
		<div class="book-field book-isbn">
			<span class="book-field-label"><?php esc_html_e( 'ISBN:', 'wc-flavor-books' ); ?></span>
	...
	<?php if ( ! empty( $meta['year'] ) ) : ?>
		<div class="book-field book-year">
			<span class="book-field-label"><?php esc_html_e( 'Year:', 'wc-flavor-books' ); ?></span>
	...
	<?php if ( ! empty( $meta['pages'] ) ) : ?>
		<div class="book-field book-pages">
			<span class="book-field-label"><?php esc_html_e( 'Pages:', 'wc-flavor-books' ); ?></span>
	...
	<?php if ( ! empty( $meta['format'] ) ) : ?>
		<div class="book-field book-format">
			<span class="book-field-label"><?php esc_html_e( 'Format:', 'wc-flavor-books' ); ?></span>
	...
	<?php if ( ! empty( $meta['condition'] ) ) : ?>
		<div class="book-field book-condition">
			<span class="book-field-label"><?php esc_html_e( 'Condition:', 'wc-flavor-books' ); ?></span>
	...
	<?php if ( ! empty( $meta['edition'] ) ) : ?>
		<div class="book-field book-edition">
			<span class="book-field-label"><?php esc_html_e( 'Edition:', 'wc-flavor-books' ); ?></span>
	...
	<?php if ( ! is_wp_error( $languages ) && ! empty( $languages ) ) : ?>
		<div class="book-field book-languages">
			<span class="book-field-label"><?php esc_html_e( 'Language:', 'wc-flavor-books' ); ?></span>
			<span class="book-field-value">
				<?php
				$links = array();
	...
	<?php if ( ! empty( $meta['original_language'] ) ) : ?>
		<div class="book-field book-original-language">
			<span class="book-field-label"><?php esc_html_e( 'Original language:', 'wc-flavor-books' ); ?></span>
